...
<div id="wrapper">
 ...
 <div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Faydalı Link Güncelle</h1>
        <!-- /.row -->
        <div class="row">
          <div class="col-lg-6">
            <?php
            if (isset($_POST["guncelle1"])) {
              $link = post("link");
                  ...
                  $db->veri = array($link, date("d, m, y"), "Linkler");
                  $guncelle = $db->update();
                  if($guncelle){
                    ...
                    <form role="form" method="POST"> <!-- Yazı Post-Form Kısmı -->
                      <div class="form-group ckeditor">
                        ...
                        foreach ($link as $key => $value) {
                         ?>
                        <label>Link Gir:</label>
                        <textarea name="link" rows="10" class="form-control ckeditor"><?=$value->text;?></textarea>
                      </div>
                        <?php 
                      }
                       ?>
