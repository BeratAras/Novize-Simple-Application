    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12" style="width: 100%;">
                ...
                { 
                    ?>
                    <h1 class="page-header">Kadın Üyeler</h1>
                    <?php 
                ...
                ?>
                <?php //Tüm Kadın Üyeler çağırılıyor. Kadın Üyeler olmaması dahilinde "Bulunamadı" mesajı veriliyor.
                $db->sql = " select * from users where users.confirmed = 1 and sex='Kadın'";
                $Uyeler = $db->select();
                if ($Uyeler == false) {
                    echo "<p>Kadın Üye Yok.</p>";
                }else{ //Kadın Üyeler varsa yapılacak işlemler belirleniyor. 
                   ?>
